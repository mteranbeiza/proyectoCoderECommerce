...
urlpatterns = [
    ...
    path('puntosdeventa_list', views.PuntosdeventaList.as_view(), name= "Puntosdeventa_List"),
    path(r'^ (?P<pk>\d+)$', views.PuntosdeventaDetalle.as_view(), name= "Puntosdeventa_Detalle"),
    path(r'^nuevo$', views.PuntosdeventaCrear.as_view(), name= "Puntosdeventa_Nuevo"),
    path(r'^editar/(?P<pk>\d+)$' , views.PuntosdeventaUpdate.as_view(), name= "Puntosdeventa_Edit"),
    path(r'^borrar/(?P<pk>\d+)$' , views.PuntosdeventaDelete.as_view(), name= "Puntosdeventa_Delete"),
